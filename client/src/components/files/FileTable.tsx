    ...
    <AnimatePresence mode="wait" initial={false}>
      ...
      >
        <Table className={className}>
          ...
          <TableBody>
            {/* Per-row presence, so a single delete still animates its row out.
                A full list swap never reaches here: the outer wrapper remounts. */}
                  ...
                  >
                    <TableCell>
                      <div className="flex min-w-0 items-center gap-3">
                        ...
                        <Badge
                          tone={kind.colorVar.replace("--", "") as BadgeTone}
                          className="shrink-0"
                        >
                          {kind.group}
                        </Badge>
